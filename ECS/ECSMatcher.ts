import type { IComp, IMatcher } from "./ECS";
 ...
 */
export class ECSMatcher implements IMatcher {
     ...
     * @param args 组件索引
     */
    anyOf(...args: CompType<IComp>[]): ECSMatcher {
     ...
     * @param args 组件索引
     */
    allOf(...args: CompType<IComp>[]): ECSMatcher {
     ...
     * @param args 组件索引
     */
    onlyOf(...args: CompType<IComp>[]): ECSMatcher {
        this.rules.push(new AllOf(...args));
