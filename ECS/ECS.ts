import { ECSComp, ECSCCComp } from "./ECSComp";
...
/** Cocos组件 - 挂载在节点上的组件，注册时 canNew 必须为 false */
export type CCComp = ECSCCComp;
 ...
 * @param canNew 标识是否可以new对象。想继承自Cocos Creator的组件就不能去new，需要写成@register('name', false)
 */
