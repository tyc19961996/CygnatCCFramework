import type { Entity, IComp, IMatcher, System } from "./ECS";
...
export class ECSModel {
    ...
    static compTid = 0;
    /** 组件缓存池 */
    static compPools: Map<number, IComp[]> = new Map();
    ...
    /** 编号获取组件 */
    static tid2comp: Map<number, IComp> = new Map();
     ...
     * @param matcher 实体筛选器
     */
    static createGroup<E extends ECSEntity = ECSEntity>(matcher: IMatcher): ECSGroup<E> {
    ...
    /** 系统组件 */
    static systems: Map<string, System> = new Map<string, System>();
}