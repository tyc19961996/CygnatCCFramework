...
import { Node, Component, Enum, tween, _decorator, EventHandler, Tween, ScrollView, Prefab, Layout, Vec2, Size, NodePool, isValid, instantiate, Vec3, Widget, UITransform, CCFloat, CCBoolean, CCInteger, Event } from 'cc';
...
export default class List extends Component {
    ...
    // 触摸时
    _onTouchStart(ev:Event, captureListeners) {
