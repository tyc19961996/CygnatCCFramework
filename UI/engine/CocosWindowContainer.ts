...
@menu("cygnat/CocosWindowContainer")
export class CocosWindowContainer extends Component {
    ...
    public init(): void {
        ...
        Log(`\tUIContainer name:${name} 忽略顶部窗口查询:${this.ignoreQuery} 吞噬触摸事件:${this.swallowTouch}`);
        ...
        WindowManager.addWindowGroup(new WindowGroup(name, this.node, this.ignoreQuery, this.swallowTouch));
    }
}