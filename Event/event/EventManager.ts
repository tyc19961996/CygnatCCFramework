...
export class EventManager {
     ...
     */
    public on(name: string, callback: (...args: any[]) => void, target?: any): number {
        if (!name) {
     ...
     * @returns 返回事件ID，可用于移除事件
     */
    public once(name: string, callback: (...args: any[]) => void, target?: any): number {
        if (!name) {
            throw new Error("事件名称不能为空");
        }
        if (!callback) {
     ...
     */
    public emit(name: string, target?: any, ...args: any[]): void {
